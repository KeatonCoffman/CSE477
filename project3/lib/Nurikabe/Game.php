...
HTML;
    ...
    public $solution = [
        '3x3 Ultra Easy' => ['desc'=>'3x3 Ultra Easy',
            'game'=>[
                [1, Cell::SEA, 1],
        ...
        '8x8 Very Easy' => ['desc'=>'8x8 Very Easy',
            'game'=>[
    ...
    public function getSolutions($desc){
        return $this->solution[$desc]['game'];
    }
